  ...
  * A multiple line graph was created using the Five Thirty Eight style and object oriented method
  ...
  ### Results
   ...
   ![fig1](https://github.com/femolyn1/PyBer_Analysis/blob/master/Images/Formatted%20Data%20Frame%20showing%20Key%20metrics.png)
    ...
    ![fig 2](https://github.com/femolyn1/PyBer_Analysis/blob/master/Images/Multiple%20line%20graph.png)
    
   As shown in the multiple line graph (fig 2 above), the urban cities had the highest total fare within the months of January to April 2019 followed by the rural cities while the urban cities had the lowest fare. The data frame created using the loc function on the pivot data, shown below, helps to explain the reason for the low fares in the suburban and rural cities within the months of January to April 2019.
